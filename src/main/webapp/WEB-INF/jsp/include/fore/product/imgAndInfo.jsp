...
<script>
    $(function () {
                        ...
                        $.get(
                            ...
                            function (result) {
                                if ("success" == result) {
                                    ...
                                    $(".addCartButton").css("color", "#337ab7")
                                }
                                else {
                                }
                            }
        ...
        $(".loginInput input").keyup(function () {
...
<div class="imgAndInfo">
    ...
    <div class="infoInimgAndInfo">
        <div class="productTitle text-primary">
            ${p.name}
        </div>
        <div class="productSubTitle text-muted">
            ${p.title}
        </div>
        <div class="productPrice">
            <div class="cuxiao">
                <span class="juhuasuanBig">促销</span>
                <span>大减价<span class="juhuasuanTime">剩余3天</span></span>
            </div>
            <div class="productPriceDiv">
                <div class="originalDiv">
                    ...
                    <span class="originalPrice">
                        <fmt:formatNumber type="number" value="${p.initialPrice}" minFractionDigits="2"/>
                    </span>
                </div>
        ...
        <div class="productSaleAndReviewNumber">
            <div>销量 <span class="blueColor boldWord"> ${p.saleCount }</span></div>
            <div>累计评价 <span class="blueColor boldWord"> ${p.reviewCount}</span></div>
        </div>
