                ...
                <div>
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle" action="admin_productImage_add"
                                ...
                                <table class="addTable">
                                    ...
                                    <tr class="submitTR">
                                        <td align="center">
                                            <input type="hidden" name="imageType" value="type_single"/>
                    ...
                    <table class="table table-striped table-bordered table-hover text-center">
                        ...
                        <tr>
                            ...
                            <th class="text-center">产品单个图片缩略图</th>
            ...
            <td class="addPictureTableTD">
                <div>
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormDetail" action="admin_productImage_add"
                                ...
                                <table class="addTable">
                                    ...
                                    <tr class="submitTR">
                                        <td align="center">
                                            <input type="hidden" name="imageType" value="type_detail"/>
                                            <input type="hidden" name="pid" value="${p.id}"/>
                                            <button type="submit" class="btn btn-primary">提交</button>
                                        </td>
                                    </tr>
                    ...
                    <table class="table table-striped table-bordered table-hover text-center">
                        ...
                        <tr>
                            <th class="text-center">ID</th>
                            <th class="text-center">产品详细图片缩略图</th>
                            <th class="text-center">删除</th>
                        </tr>
                        </thead>
                        <tbody>
